...
def column_switch_by_step(
    ...
    # 新しい列を追加
    column_type = detect_column_type([values1, values2])
    result.add_column(result_column, new_values, column_type=column_type)

    return result


@operation(domain="core")
def column_blend_by_step(
    collection: ColumnCollection,
    column1: str,
    column2: str,
